...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased flex flex-col bg-primary_dark text-primary_text_dark`}
      >
        ...
        />
        <NavBarProtected />
        <div className="flex pt-[8vh] w-full min-h-screen z-10">
          {children}
        </div>
        <Footer />
      </body>
