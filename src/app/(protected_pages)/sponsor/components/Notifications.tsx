  ...
  const getUserNotifications = async () => {
    try {
      ...
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}${api_paths.notification}?userId=${localUserDetails?.id}`,
        {
          headers: {
      ...
      <div className="flex flex-col gap-6 pt-4 p-8 w-full h-full">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-2 p-2">
            ...
            <div className="flex flex-col gap-2 max-h-[500px] w-[70%] pr-4 overflow-y-auto">
