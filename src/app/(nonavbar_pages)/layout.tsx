...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased flex flex-col bg-primary_dark h-screen text-primary_text_dark relative`}
      >
        ...
        />
        {/* <AdminNavbar /> */}
        <div className="flex w-screen pt-[8vh] h-max z-20">{children}</div>
        {/* <Footer /> */}
      </body>
    </html>
  );
