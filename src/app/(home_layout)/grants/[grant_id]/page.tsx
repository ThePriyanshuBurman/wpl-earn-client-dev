...
export default function Page() {
  ...
  return (
    <div className="flex flex-col gap-8 mt-6 sm:mt-[6%] mb-8 px-4 sm:px-[8%] h-full w-full text-primary_text_dark z-20">
      {/* Back Button */}
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 w-full">
        {/* Left Section */}
        <div className="flex flex-col gap-8 w-full lg:w-[70%] h-full backdrop-filter backdrop-blur-sm">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
            <img src="/images/png/grant.png" className="h-16 w-16 rounded-lg" alt="" />
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-4 text-sm">
                <p className="font-polysansbulky text-lg">{grantDetails?.title}</p>
              ...
              <div className="flex items-center gap-1 text-secondary_text_dark pr-4">
                ...
                <img src="/images/png/verified.png" className="h-4 w-4" alt="" />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">{grantDetails?.grantDescription}</div>
          </div>
        </div>
  
        {/* Right Section (Sidebar) */}
        <div className="flex w-full lg:w-[30%] lg:sticky top-[15%]">
          <div className="flex flex-col gap-5 w-full bg-secondary_dark p-4 rounded-lg relative overflow-hidden">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="font-polysansbulky">
                  ...
                  <span className="text-secondary_text_dark">{grantDetails?.prizeCurrency}</span>
                </p>
              </div>
            </div>
            ...
            <PrimaryButton>
              <Link href={grantDetails?.link || ""} target="_blank" className="hover:underline">
                <div>
                  <p>Apply Now</p>
                </div>
              </Link>
